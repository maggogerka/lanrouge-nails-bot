...
from app.domain.appointments import ensure_active_appointment, ensure_client_change_deadline
...
def test_less_than_36_hours_is_blocked_with_required_message() -> None:
    with pytest.raises(CancellationDeadlineError, match="меньше 36 часов"):
        ensure_client_change_deadline(
