...
Перед созданием окон настройте «Настройки бизнеса → Рабочие места». Создайте физические столы,
кресла или кабинеты и отметьте услуги, которые можно выполнять на каждом месте. Одно рабочее
место не может обслуживать пересекающиеся окна. Если два места поддерживают одну услугу, два
разных мастера смогут открыть пересекающиеся окна этой услуги. Это правило обязательно и для
