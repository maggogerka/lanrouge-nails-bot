...
Текущая версия — **v0.4.5**. Runtime-интерфейс получает бренд и опубликованное
приветствие из БД.
...
- завершение визита с момента начала окна, прямой переход из напоминания сотруднику и
  локализованная финансовая история записей клиента;
- feature flags бизнеса и динамические меню;
- отключённая, ручная или YooKassa-предоплата, временный резерв, webhook и возвраты;
- защищённый клиентский раздел «Мои оплаты» с действующими инструкциями, историей и пагинацией;
...
Карточки мастеров работают так же: опубликованное фото показывается сразу, а стрелки меняют
мастера без отдельной кнопки просмотра фотографии.
